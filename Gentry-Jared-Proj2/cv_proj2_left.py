...
two_D_pts = np.loadtxt('../Gentry-Jared-Proj2/stereo_data/calibration/leftcamera.txt', usecols = (1,2))
three_D_pts_1 = np.loadtxt('../Gentry-Jared-Proj2/stereo_data/calibration/modeldata.txt', usecols = (1,2,3))
...
def main(m, M_1, isNormalized, H_2D=H_2D, H_3D=H_3D, two_D_pts=two_D_pts, three_D_pts_1=three_D_pts_1):
	...
	m_c = m[0:53] # 42 pts (0:42); now using 52 pts
	m_e = two_D_pts[53:54] # 12 pts (42:54); now using 1 pt
	M_1_c = M_1[0:53]
	M_1_e = three_D_pts_1[53:54]
	...
	print("Average projection error:", sum_error/len(m_e), "\n")
	return P
